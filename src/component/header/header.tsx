...
return(
    <header className={styles.header}>
      ...
      <button className={styles.menuBtn} onClick={handleToggle} ><svg xmlns="http://www.w3.org/2000/svg" className={[styles.svg,localStorage.getItem('bgMode')=="light" ?  styles.dark :styles.light ].join(" ")} fill="none" viewBox="0" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 6h16M4 12h8m-8 6h16"></path></svg></button>
        ...
        <div className={styles.inputbox}>
          <button onClick={() => {toggleDarkMode();darkModeBtn()}} className={styles.bgBtn}id="bgBtn">
            {localStorage.getItem('bgMode')=="light" ? <MdLightMode /> : <MdOutlineNightlight />}
          </button>
          <div className={styles.inputContainer}>
          <svg xmlns="http://www.w3.org/2000/svg" className={styles.inputIcon} fill="none" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z"></path></svg>
        ...
        <ul className={styles.searchui}>
          ...
          <Link to={'/cart'}>
              ...
              <span className={styles.shopCount} id='count'>{cartItemsCount}</span>
          </Link>
          </div>
        </div>
      </nav>
